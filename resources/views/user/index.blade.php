      ...
      <div class="row">
        <div class="col-md-6 ">
          <div class="detail-box">
            ...
            // Assuming $data is a valid date/time string or a DateTime object
            $dataTime = new DateTime($data);
            
            // Calculate the difference between now and $data
            $timeDifference = $currentTime->diff($dataTime);
            
            // Access the difference in hours, minutes, and seconds
            $hours = $timeDifference->h;
            $secundes = $timeDifference->s;
            $hours = $timeDifference->h;
            @endphp
        ...
        <div class="col-md-6">
          <div class="img-box"style='margin-top:38px;'>
